...
@Autonomous(name="Blue team get beacon one", group="Testing")  // @Autonomous(...) is the other common choice

public class goToFirstBeaconBlue extends LinearVisionOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //THIS IS REVERSED
        if(leftColor == robot.BEACON_BLUE){
